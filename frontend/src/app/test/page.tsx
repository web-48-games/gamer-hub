...
export default function () {
    return(
        <>
            <section className="bg-gh-desert-300 border-2 border-gh-mesa-400 p-1">
                <div className={"bg-gh-mesa-200 border-2 border-accent-neutral m-2 p-2"}>Headings:
                ...
                <div className={"bg-gh-teal-200 border-2 border-accent-green m-2 p-2"}>Testing more colors</div>

                <div className={"bg-gh-red-100 border-2 border-accent-purple m-2 p-2"}>Everything else:
