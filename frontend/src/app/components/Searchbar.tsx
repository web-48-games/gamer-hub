                ...
                <div className="flex">
                    ...
                    <div className="relative w-full">
                        <input type="search" id="search-dropdown"
                               ...
                               placeholder="Search Games, Sesssions, etc..." required/>
                        <button type="submit"
                                className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-lightRed rounded-e-lg border border-redBrown focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
