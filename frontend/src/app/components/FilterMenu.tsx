...
export function FilterMenu() {
    ...
    return (
        <>
            ...
            {/*smooth transitions*/}
            <section className={`bg-sandyYellow border-2 border-solid border-black rounded fixed p-4 md:sticky left-0 top-0 md:top-24 md:m-6 h-screen md:h-auto transition-all duration-300 z-10
