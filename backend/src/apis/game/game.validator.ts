...
export const GameSchema = z.object({
    ...
    gameDescription: z.string().max(512, {message: 'please provide valid gameDescription max(512 chars)'}),
    gameGenre: z.string().max(32, {message: 'please provide valid gameGenre max(32 chars)'}),
